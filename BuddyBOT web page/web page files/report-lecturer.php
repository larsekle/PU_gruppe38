<?php 
  ...
  include ("db-lecturer.php");
  session_start(); 

  //sets assignment from register.php. Starts at -1, which means all assignments. Stores the $username for use in header.
  //Checks if the $_SESSION variable is set to prevent unwanted access.
  //if not: return to login page.
  if($_GET['ass'] AND isset($_SESSION['lecturer'])){
    $ass = $_GET['ass'];
...
<link rel="stylesheet" type="text/css" href="repTest.css"> 
  ...
  <?php
    ...
    $db = new LecturerDatabase();
    $conn = $db->getConnection();
    
    $assignmentsList = $db->assignmentsList();
    $assignmentsList2 = $db->assignmentsList();
    $totalTags_amt = $db->totalTags($ass);
    $uniqueUsers_amt = $db->uniqueUsers($ass);
    $countFailures24H = $db->failuresNoLimit($ass);
    $tagDistribution = $db->tagDistribution($ass);
    $strugStud = $db->strugStud($ass);
    $mostVisited = $db->mostVisited($ass);
    $bestRated = $db->bestRated($ass);
    $recentFailures = $db->recentFailures($ass);

    //fills the array $assignments with the different assignmentnumbers
    while($row = mysqli_fetch_array($assignmentsList2)){
      array_push($assignments, $row[0]);
    }

    /**
     * Failure progress on assignments-graph.
     * Fills the arrays $failureList with the average amount of failures by all students on the specified assignment in the query
     */
    for($i=0; $i < sizeof($assignments); $i++){ 
      $staticAss = $assignments[$i]; 
      $tagAmt = $db->totalTags($staticAss);
      $students = $db->uniqueUsers($staticAss);
      array_push($failureList, round($tagAmt/$students,1));
    }
    ...
    */
     ...
     */
    $assUsers = $db->assUsers($ass);
    $percentage_ex1 = $db->exUsers($ass,1,$assUsers);
    $percentage_ex2 = $db->exUsers($ass,2,$assUsers);
    $percentage_ex3 = $db->exUsers($ass,3,$assUsers);
    $percentage_ex4 = $db->exUsers($ass,4,$assUsers);
    $percentage_ex5 = $db->exUsers($ass,5,$assUsers);
    $percentage_ex6 = $db->exUsers($ass,6,$assUsers);
?>
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="http://folk.ntnu.no/ingriehe/index.html">BuddyBOT - Dashboard for lecturers</a>
        <a name = "pagetop"></a>
      </div>
      <!-- /.navbar-header -->
                ...
                <a href="#">
                  <div>
                    ...
                    <div class="progress progress-striped active">
                      <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $percentage_ex1 ?>%">
                ...
                <li>
                  <a href="#">
                    <div>
                      ...
                      <div class="progress progress-striped active">
                        <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $percentage_ex2 ?>%">
                ...
                <li>
                  <a href="#">
                    <div>
                      ...
                      <div class="progress progress-striped active">
                        <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $percentage_ex3 ?>%">
                  ...
                  <li>
                    <a href="#">
                      <div>
                        ...
                        <div class="progress progress-striped active">
                          <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $percentage_ex4 ?>%">
                    ...
                    <li>
                      <a href="#">
                        <div>
                          ...
                          <div class="progress progress-striped active">
                            <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $percentage_ex5 ?>%">
                              <span class="sr-only">40% Complete (success)</span>
                            </div>
                          </div>
                        </div>
                    ...
                    <li>
                      <a href="#">
                        <div>
                          ...
                          <div class="progress progress-striped active">
                            <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $percentage_ex6 ?>%">
                              <span class="sr-only">20% Complete</span>
                            </div>
                          </div>
                        </div>
      ...
      <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Select assignment<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level">
                <li>
                  <a href="report-lecturer.php?ass=-1">All assignments</a>
                </li>
                <?php
                  while ($row = mysqli_fetch_array($assignmentsList)) {
                    $ass_nr = $row[0];
                ?>
                    <li><a href = "report-lecturer.php?ass=<?php echo $ass_nr; ?>">Assignment <?php echo $ass_nr ?></a></li>
                    <?php
                  }
                    ?>                     
              </ul>
